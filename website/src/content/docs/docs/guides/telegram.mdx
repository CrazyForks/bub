---
title: Telegram
description: Telegram channel setup, environment variables, message behavior, outbound behavior, and access control.
---
...
For group chats, disable the bot's Privacy mode in BotFather. Bub must receive non-command group messages so the channel filter and debounce logic can decide whether to respond.
